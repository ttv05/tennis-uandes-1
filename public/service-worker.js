const CACHE_NAME = 'tenis-uandes-v1';
const urlsToCache = [
  '/',
  '/index.html',
...
self.addEventListener('fetch', (event) => {
  ...
  // Skip API requests (tRPC) - always use network
...
async function syncAvailability() {
  try {
    // This would sync any pending availability updates
    console.log('[ServiceWorker] Syncing availability...');
  } catch (error) {
